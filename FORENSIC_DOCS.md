...
- **What it does**: Provides a professional, authoritative entry sequence featuring the Anantapur Police insignia and high-fidelity animations.
- **Why it's there**: To establish trust and professionalism for an intelligence-grade tool used by law enforcement.
- **Tech Stack**: **Framer Motion** + **React**.
- **Rationale**: Framer Motion allows for high-performance, declarative animations that don't bog down the initial page load while providing a "premium" feel.
...
### 3. **Live Transaction Dashboard & Summary Widgets**
...
### 4. **Automated Forensic Ingestion (One-Click Ingestion)**
...
### 5. **Multi-Layer Risk Scoring Engine**
...
### 6. **Interactive Investigation Graph (FFAP Trace)**
...
### 7. **Network Summary Dashboard (Graph View)**
...
### 9. **Hold Trace Propagation (One-Click Freeze)**
...
### 11. **Legal Notice Generation (Section 91 CrPC)**
