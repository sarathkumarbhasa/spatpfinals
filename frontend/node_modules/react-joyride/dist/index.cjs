...
function JoyrideOverlay(props) {
	...
	const previousLifecycleRef = (0, react.useRef)(lifecycle);
	const overlayRef = (0, react.useRef)(null);
	const [showSpotlight, setShowSpotlight] = (0, react.useState)(false);
...
function JoyrideFloater(props) {
	...
	(0, react.useEffect)(() => {
		...
		return (0, _floating_ui_react_dom.autoUpdate)(ref, floating, tooltipFloating.update, step.floatingOptions?.autoUpdate);
	}, [
		lifecycle,
...
function TourRenderer({ controls, mergedProps, state, step, store }) {
	...
	const handleClickOverlay = (0, react.useCallback)(() => {
		...
		else if (step?.overlayClickAction === "next") controls.next();
