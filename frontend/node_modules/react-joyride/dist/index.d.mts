'use client';
import { CSSProperties, ElementType, MouseEventHandler, ReactElement, ReactNode, RefObject } from "react";
...
type Controls = {
  ...
  next: () => void; /** Open the tooltip for the current step. */
  open: () => void; /** Go back to the previous step. */
  prev: () => void; /** Reset the tour. Optionally restart from the beginning. */
...
declare function Joyride(props: Props): react_jsx_runtime0.JSX.Element | null;
//#endregion
