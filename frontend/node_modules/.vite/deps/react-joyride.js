...
function JoyrideOverlay(props) {
  ...
  const previousLifecycleRef = (0, import_react39.useRef)(lifecycle);
  const overlayRef = (0, import_react39.useRef)(null);
  const [showSpotlight, setShowSpotlight] = (0, import_react39.useState)(false);
  ...
  (0, import_react39.useEffect)(() => {
    ...
    if ((lifecycle === LIFECYCLE.TOOLTIP || lifecycle === LIFECYCLE.TOOLTIP_BEFORE) && previousLifecycle !== LIFECYCLE.TOOLTIP && previousLifecycle !== LIFECYCLE.TOOLTIP_BEFORE && placement !== "center") setShowSpotlight(true);
    else if (lifecycle === LIFECYCLE.COMPLETE && previousLifecycle !== LIFECYCLE.COMPLETE) setShowSpotlight(false);
  }, [lifecycle, placement]);
...
function JoyrideFloater(props) {
  ...
  (0, import_react39.useEffect)(() => {
    ...
    if (!ref || !floating || lifecycle !== LIFECYCLE.TOOLTIP) return;
    return autoUpdate(ref, floating, tooltipFloating.update, (_a2 = step.floatingOptions) == null ? void 0 : _a2.autoUpdate);
  }, [
    lifecycle,
...
function TourRenderer({ controls, mergedProps, state, step, store }) {
  ...
  (0, import_react39.useEffect)(() => {
    ...
    const handleKeyboard = (event) => {
      ...
      if (event.key === "Escape" && step.dismissKeyAction) if (step.dismissKeyAction === "next") controls.next();
  ...
  const handleClickOverlay = (0, import_react39.useCallback)(() => {
    if ((step == null ? void 0 : step.overlayClickAction) === "close") controls.close(ORIGIN.OVERLAY);
    else if ((step == null ? void 0 : step.overlayClickAction) === "next") controls.next();
